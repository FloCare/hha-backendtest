...
from user_auth.views import UpdateStaffView
import logging
import uuid
...
class TestUpdateStaffView(test_helpers.UserRequestTestCase):
    ...
    def test_post_different_org(self):
    ...
    def test_post_update(self):
        ...
        self.user_org_access_ds_mock.get_user_org_access_by_user_profile.return_value = user_org
        self.user_org_access_ds_mock.get_user_org_access_by_user_id.return_value = user_1_org
        validate_response = MagicMock(name='validate_response')
        validate_method_mock = self.patch_class(
            'user_auth.views.user_profile_views.UpdateStaffView.validate_and_format_request', validate_response)
        channel = 'channel'
        message = 'message'
        ...
        self.user_ds_mock.update_user_by_uuid.assert_called_once_with(user_id, validate_response)
